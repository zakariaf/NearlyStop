...
class $DoseLogsTable extends DoseLogs
  ...
  late final GeneratedColumnWithTypeConverter<LocalDate, String> date =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<LocalDate>($DoseLogsTable.$converterdate);
  @override
  late final GeneratedColumnWithTypeConverter<Milligrams, int> plannedMg =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<Milligrams>($DoseLogsTable.$converterplannedMg);
  @override
  late final GeneratedColumnWithTypeConverter<Milligrams, int> actualMg =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<Milligrams>($DoseLogsTable.$converteractualMg);
  ...
  late final GeneratedColumnWithTypeConverter<DateTime?, int> takenAt =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: false,
      ).withConverter<DateTime?>($DoseLogsTable.$convertertakenAtn);
  ...
  DoseLogRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DoseLogRow(
      ...
      date: $DoseLogsTable.$converterdate.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}date'],
        )!,
      ),
      plannedMg: $DoseLogsTable.$converterplannedMg.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}planned_mg'],
        )!,
      ),
      actualMg: $DoseLogsTable.$converteractualMg.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
      ...
      takenAt: $DoseLogsTable.$convertertakenAtn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class DoseLogRow extends DataClass implements Insertable<DoseLogRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['plan_id'] = Variable<int>(planId);
    {
      map['date'] = Variable<String>($DoseLogsTable.$converterdate.toSql(date));
    }
    {
      map['planned_mg'] = Variable<int>(
        $DoseLogsTable.$converterplannedMg.toSql(plannedMg),
      );
    }
    {
      map['actual_mg'] = Variable<int>(
        $DoseLogsTable.$converteractualMg.toSql(actualMg),
      );
    }
    map['taken'] = Variable<bool>(taken);
    if (!nullToAbsent || takenAt != null) {
      map['taken_at'] = Variable<int>(
        $DoseLogsTable.$convertertakenAtn.toSql(takenAt),
      );
    }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (date.present) {
      map['date'] = Variable<String>(
        $DoseLogsTable.$converterdate.toSql(date.value),
      );
    }
    if (plannedMg.present) {
      map['planned_mg'] = Variable<int>(
        $DoseLogsTable.$converterplannedMg.toSql(plannedMg.value),
      );
    }
    if (actualMg.present) {
      map['actual_mg'] = Variable<int>(
        $DoseLogsTable.$converteractualMg.toSql(actualMg.value),
      );
    }
    if (taken.present) {
    ...
    if (takenAt.present) {
      map['taken_at'] = Variable<int>(
        $DoseLogsTable.$convertertakenAtn.toSql(takenAt.value),
      );
    }
    if (note.present) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final StepDao stepDao = StepDao(this as AppDatabase);
...
class $$TaperPlansTableTableManager
    extends
        RootTableManager<
          ...
          (
            TaperPlanRow,
            BaseReferences<_$AppDatabase, $TaperPlansTable, TaperPlanRow>,
          ),
          TaperPlanRow,
...
class $$StepsTableTableManager
    extends
        RootTableManager<
          ...
          (StepRow, BaseReferences<_$AppDatabase, $StepsTable, StepRow>),
          StepRow,
          PrefetchHooks Function()
        > {
...
class $$FlareEventsTableFilterComposer
    extends Composer<_$AppDatabase, $FlareEventsTable> {
...
class $$FlareEventsTableTableManager
    extends
        RootTableManager<
          ...
          (
            FlareEventRow,
            BaseReferences<_$AppDatabase, $FlareEventsTable, FlareEventRow>,
          ),
          FlareEventRow,
          PrefetchHooks Function()
        > {
  $$FlareEventsTableTableManager(_$AppDatabase db, $FlareEventsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$HoldEventsTableFilterComposer
    extends Composer<_$AppDatabase, $HoldEventsTable> {
...
class $$HoldEventsTableTableManager
    extends
        RootTableManager<
          ...
          (
            HoldEventRow,
            BaseReferences<_$AppDatabase, $HoldEventsTable, HoldEventRow>,
          ),
          HoldEventRow,
          PrefetchHooks Function()
        > {
  $$HoldEventsTableTableManager(_$AppDatabase db, $HoldEventsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
