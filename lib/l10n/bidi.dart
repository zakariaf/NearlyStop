...
String _isolate(String value, String opening) {
  if (value.startsWith(opening) && value.endsWith(pdi)) return value;
  return '$opening$value$pdi';
}

/// Removes every isolate character from [value], leaving all else identical.
///
/// The boundary call. An isolate in a CSV field, a database write or a search
/// query is invisible in review and silently corrupts the value.
